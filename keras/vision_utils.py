...
def get_pair(root_path,child):
    imgpath_labels=[]
    file_names=[i for i in os.listdir(root_path/child)]
    for name in file_names:
        label,_=name.split('_')
        imgpath_labels.append((str(root_path/child/name),int(label)))
    return imgpath_labels
